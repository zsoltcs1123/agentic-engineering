...
| Milestone     | One phase/module — task list + validation suite                | `plan-tasks`, `plan-validations` |
| Task          | Single task — description, requirements, verification scenarios|  —                               |
| Plan          | Structured executable plan — codebase-aware, file-level steps  | `structured-plan`                |
